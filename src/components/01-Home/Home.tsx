      ...
      <div>
        <div className="homePageIntroCont">
          <section className="w-full px-2 py-12 grid grid-cols-1 md:grid-cols-2 items-center gap-8 max-w-7xl mx-auto">
            <div>
              <span className="block mb-4 lg:text-xl mt-10 text-xl font-bold text-[#ffff] font-medium">
                Courier Services in India
              </span>
              <h3 className="lg:text-5xl text-3xl text-[#fcb026] font-semibold">
                Fast, Reliable & Affordable Delivery Solutions{" "}
              </h3>
              <p className="lg:text-xl font-medium text-[#ffff] my-4 md:my-6">
